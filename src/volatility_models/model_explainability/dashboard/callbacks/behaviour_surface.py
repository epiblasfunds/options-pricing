...
def register_behaviour_callbacks(app, services) -> None:
    ...
    def render_behaviour(model_id, anchor_index, feature_name):
        ...
        try:
            ...
            smile_frame["TimeToExpiration"] = (
                smile_frame["TimeToExpiration"].round(1).astype(str)
            )
            ...
            term_frame["Moneyness"] = term_frame["Moneyness"].round(3).astype(str)
