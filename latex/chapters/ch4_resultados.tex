...
Este bloque combina dos perspectivas complementarias sobre explicabilidad global del modelo final. Primero se muestran reglas aproximadas mediante árboles surrogate; después, una ecuación compacta obtenida por regresión simbólica. La comparación entre ambas permite evaluar no solo interpretabilidad, sino también fidelidad real frente al predictor original.

\begin{figure}[!htbp]
  \centering
  \begin{subfigure}[t]{\textwidth}
    \centering
    \includegraphics[width=0.90\textwidth]{../imgs/dashboard/Global Explainability - Random Forest III.png}
  ...
  \begin{subfigure}[t]{\textwidth}
    \centering
    \includegraphics[width=0.90\textwidth]{../imgs/dashboard/Global Explainability - Random Forest II.png}
    \caption{\small Regresión simbólica de Random Forest.}
    \label{fig:dash-sr-xgb}
  \end{subfigure}
  \caption{\small Modelos equivalentes del Random Forest en dashboard.}
  \label{fig:dash-equivalent-models-rf}
\end{figure}

La Figura~\ref{fig:dash-equivalent-models-rf} resume visualmente las dos aproximaciones en un único bloque para facilitar comparación directa. Sobre esa base visual, la Tabla~\ref{tab:symbolic-fidelity-all-models} cuantifica qué familias conservan mejor la fidelidad cuando se sustituyen por una expresión simbólica.
...
Antes de cerrar la comparación, conviene contrastar también la fidelidad de árboles surrogate por profundidad. Esa lectura completa la parte simbólica y evita sobredimensionar una única técnica de explicación.
...
\begin{subfigure}[t]{\textwidth}
  \centering
  \includegraphics[width=0.89\textwidth]{../imgs/dashboard/Sample Explainability - Random Forest I.png}
...
\begin{subfigure}[t]{\textwidth}
  \centering
  \includegraphics[width=0.89\textwidth]{../imgs/dashboard/Sample Explainability - Random Forest II.png}
...
\end{subfigure}
\caption{\small Explicabilidad local en modo \emph{dataset} para la misma observación (ID 3018).}
\label{fig:dash-local-dataset-rf-combined}
\end{figure}
...
Una vez fijado ese caso base, se introduce un escenario más exigente para comprobar estabilidad de la explicación cuando el contrato se desplaza hacia una zona potencialmente más sensible de la superficie.



\begin{figure}[!htbp]
\centering
\includegraphics[width=0.89\textwidth]{../imgs/dashboard/Sample Explainability - Random Forest III.png}
